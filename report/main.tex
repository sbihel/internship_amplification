...
But writing and maintaining many test cases is time-consuming for the developers and as they are humans they can miss some edge cases resulting in sub-optimal testing.
% ----- SBST
To address these problems, automated methods have been developed to generate tests from scratch, optimise test suites, or extend test suites.
...
% -----
Tools have been developed to amplify test suites but optimising the generated tests is still an open problem.
...
% \addref{A Systematic Literature Review on Test Amplification}
...
% \addref{Genetic-Improvement based Unit Test Amplification for Java}
...
% commit \texttt{f9fd484c389c1905155f0dd3316e4bb13684f2d0}
...
\begin{table}
  ...
  \label{tab:perf_exp}
\end{table}
\footnotetext{\url{https://github.com/xwiki/xwiki-commons/tree/master/xwiki-commons-core/xwiki-commons-crypto/xwiki-commons-crypto-cipher}}
...
\begin{listing}[H]
  \centering
  \begin{minted}[linenos,frame=lines,xleftmargin=-3em,xrightmargin=-5em,breaklines]{java}
@Test(timeout = 10000)
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[height=0.88\textheight]{message_ex1}}%
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[trim=0cm 11cm 0cm 9cm,clip,width=\textwidth]{message_ex1_unfolded}}%
