...
\todo{more on literal neighbours}
...
With~\dspot{}~\cite{baudry2015dspot}\addref{new dspot paper}\footnote{\url{https://github.com/STAMP-project/dspot}} the goal is to extend the oracle by covering more of the input space ---~\figurename~\ref{fig:io-spaces} illustrates the input and output spaces of test cases.
...
To extend the oracle~\dspot{} adds assertions in tests.
